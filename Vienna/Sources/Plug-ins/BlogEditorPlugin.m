...
static NSString * const VNAPluginTypeInfoPlistValue = @"BlogEditor";
static NSString * const VNABundleIdentifierInfoPlistKey = @"BundleIdentifier";

@implementation VNABlogEditorPlugin

- (nullable instancetype)initWithBundle:(NSBundle *)bundle
{
    self = [super initWithBundle:bundle];
    if (!self || !self.targetBundleIdentifier) {
        return nil;
    }
    return self;
}
...
{
    return self.bundle.infoDictionary[VNABundleIdentifierInfoPlistKey];
}

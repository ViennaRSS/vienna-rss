...
static NSString * const VNAPluginTypeInfoPlistValue = @"SearchEngine";
static NSString * const VNAQueryStringInfoPlistKey = @"SearchQueryString";

@implementation VNASearchPlugin

- (nullable instancetype)initWithBundle:(NSBundle *)bundle
{
    self = [super initWithBundle:bundle];
    if (!self || !self.queryString) {
        return nil;
    }
    return self;
}

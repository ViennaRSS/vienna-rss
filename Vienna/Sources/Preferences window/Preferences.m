...
-(NSDictionary *)allocFactoryDefaults
{
	...
	defaultValues[MAPref_AutoSortFoldersTree] = [NSNumber numberWithInt:MAFolderSortManual];
	...
	defaultValues[MAPref_FilterMode] = [NSNumber numberWithInt:MAFilterAll];
	...
	defaultValues[MAPref_Layout] = [NSNumber numberWithInt:MALayoutReport];
	defaultValues[MAPref_NewArticlesNotification] = [NSNumber numberWithInt:MANewArticlesNotificationBadge];
	defaultValues[MAPref_EmptyTrashNotification] = [NSNumber numberWithInt:MAEmptyTrashWithWarning];

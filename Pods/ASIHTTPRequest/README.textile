ASIHTTPRequest is an easy to use wrapper around the CFNetwork API that makes some of the more tedious aspects of communicating with web servers easier. It is written in Objective-C and works in both macOS and iPhone applications.
...
* Get notifications about changes in your request state via delegation or [NEW] blocks (macOS 10.6, iOS 4 and above)
